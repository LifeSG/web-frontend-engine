...
const { loadWywOptions, TransformCacheCollection } = require("@wyw-in-js/transform");
...
(function() {
    if (typeof document === "undefined" || !${JSON.stringify(result.cssText)}) return;

    const style = document.createElement('style');
    style.type = 'text/css';
    style.appendChild(document.createTextNode(${JSON.stringify(result.cssText)}));

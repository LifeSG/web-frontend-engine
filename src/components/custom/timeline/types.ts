...
export interface ITimelineSchema<V = undefined, C = undefined>
	extends ICustomElementJsonSchema<"timeline">,
		Pick<TimelineProps, "className" | "data-base-indicator-testid" | "data-testid"> {
	items: ITimelineItemSchema<V, C>[];
	label: string;
}

interface ITimelineItemSchema<V = undefined, C = undefined>
	extends Omit<TimelineItemProps, "content" | "statuses" | "title"> {

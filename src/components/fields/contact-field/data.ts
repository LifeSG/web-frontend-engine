...
// TODO: import CountryData from latest DS
...
const getCountryMap = (): TCallingCodeMap => {
	...
	CountryData.forEach((item) => {
		const [countryName, ...rest]: any = item;
		const countryCode = rest.find((el: string) => /^\d+$/.test(el));

		countryMap.set(countryName, countryCode);
	});
...
export const getCountryFromPrefix = (prefix: string, country: Map<TCountry, string>): TCountry | undefined => {

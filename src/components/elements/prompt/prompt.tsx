...
export const Prompt = (props: PromptProps) => {
	...
	return (
		...
		>
			<Container
				id={TestHelper.generateId(id, "container")}
				data-testid={TestHelper.generateId(id, "container")}
				size={size}
			>
				<LabelContainer size={size}>
					...
					{typeof description === "string" ? (
						<Description
							weight="regular"
							id={TestHelper.generateId(id, "description")}
							data-test-id={TestHelper.generateId(id, "description")}
						>
							{description}
						</Description>
					) : (

...
describe("iframe", () => {
	...
	it("should be able to resize through postMessage", async () => {
		...
		expect(computedStyle.getPropertyValue("--fds-internal-iframe-fluidIframe-width")).toBe(`${width}px`);
		expect(computedStyle.getPropertyValue("--fds-internal-iframe-fluidIframe-height")).toBe(`${height}px`);
	});

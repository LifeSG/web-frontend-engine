...
Frontend Engine is developed based on [@lifesg/react-design-system](https://github.com/LifeSG/react-design-system). It relies on the design system for colours, theming, grid system and components. For more details on customising / usage / guidelines, please refer to its [storybook](https://designsystem.life.gov.sg/react/index.html?path=/docs/getting-started-installation--docs).

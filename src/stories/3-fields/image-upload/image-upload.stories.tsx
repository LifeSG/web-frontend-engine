...
const meta: Meta = {
	...
	argTypes: {
		...
		uploadOnAddingFile: {
			...
			description:
				"<div>Whether upload to API on adding file / after editing image, this can be used to do AV scan of the added file.</div><ul><li>method: HTTP method.</li><li>url: API endpoint to upload to.</li><li>sessionId: To indicate which session it belongs to.</li></ul>",
			table: {
				type: {
					summary: "{ method: post|put|patch, url: string, sessionId?: string | undefined }",
				},

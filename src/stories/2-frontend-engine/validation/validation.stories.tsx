...
import { IValidationStoryComponentProps, ValidationStoryComponent } from "./validation-story-component";
import {
...
} from "./validation-story-component.schemas";
...
const Template: StoryFn<IValidationStoryComponentProps> = (args) => <ValidationStoryComponent {...args} />;

export const ConditionalExact = Template.bind({});
ConditionalExact.storyName = "Conditional (Exact value)";
ConditionalExact.args = {
	info: {
		rule: {
			when: {
				field2: {
...
export const ConditionalSchema = Template.bind({});
ConditionalSchema.storyName = "Conditional (Schema-based)";
ConditionalSchema.args = {
	info: {
		rule: {
			when: {
				field2: {
...
export const ConditionalNested = Template.bind({});
ConditionalNested.storyName = "Conditional (Nested rule)";
ConditionalNested.args = {
	info: {
		rule: {
			when: {
				field2: {
...
EqualsField.args = {
	...
	overrides: [
		...
		},
		{
			...
			schema: { field2: Object.assign({ ...VALIDATION_DEMO_CONFIGS.nestedMultiSelect }, { label: "Field 2" }) },
...
ExcludesArray.args = {
	info: {
		...
		ruleName: "excludes",
		ruleDescription: "Meant for array-based fields, indicates that the field must exclude all specified values.",
	},
...
IncludesArray.args = {
	info: {
		...
		ruleName: "includes",
		ruleDescription: "Meant for array-based fields, indicates that the field must include all specified values.",
	},
	fields: ARRAY_BASED_VALIDATION_DEMO_FIELD_IDS,
	defaultField: "multiSelect",
};
...
export const SoftValidation = Template.bind({});
SoftValidation.args = {
	info: {
		rule: { required: true, errorMessage: "Field is required.", soft: true },
		ruleName: "soft validation",
		ruleDescription:

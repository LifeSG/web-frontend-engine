...
export declare const Description: import("styled-components").StyledComponent<"h4", any, import("@lifesg/react-design-system/v2_text").V2_TextProps, never>;
export declare const Title: import("styled-components").StyledComponent<"h4", any, import("@lifesg/react-design-system/v2_text").V2_TextProps & SizeProps, never>;
export {};

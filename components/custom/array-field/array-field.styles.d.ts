...
export declare const CustomErrorDisplay: import("styled-components").StyledComponent<({ type, img, title, description, actionButton, additionalProps, imageOnly, illustrationScheme, ...otherProps }: import("@lifesg/react-design-system/error-display").ErrorDisplayProps) => import("react/jsx-runtime").JSX.Element, any, {}, never>;
export {};

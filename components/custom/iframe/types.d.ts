...
export interface IIframeSchema extends Omit<IBaseCustomFieldSchema<"iframe">, "validation">, React.IframeHTMLAttributes<HTMLIFrameElement> {
    src: string;
    /** defaults to 2000, set -1 to skip validation */
    validationTimeout?: number | undefined;
    "data-testid"?: string | undefined;
}
export declare enum EPostMessageEvent {
...
declare function iframeEvent(referenceKey: "iframe", type: "loading", id: string, listener: TFieldEventListener, options?: boolean | AddEventListenerOptions | undefined): void;
declare function iframeEvent(referenceKey: "iframe", type: "loaded", id: string, listener: TFieldEventListener, options?: boolean | AddEventListenerOptions | undefined): void;

...
import { IYupRenderRule, IYupValidationRule, TFormYupConfig, TYupSchemaType } from "./types";
...
export declare namespace YupHelper {
     ...
     */
    const buildSchema: (yupSchemaConfig: TFormYupConfig) => Yup.ObjectSchema<ObjectShape>;
    /**
     ...
     */
    const addCondition: (type: TYupSchemaType | "mixed", name: string, fn: (value: unknown, arg: unknown, context: Yup.TestContext) => boolean) => void;
}
export {};

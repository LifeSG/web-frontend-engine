 ...
 */
export type TElementSchema<V = undefined> = IAccordionSchema<V> | IAlertSchema | IDividerSchema | IGridSchema<V> | IOrderedListSchema<V> | ITabItemSchema<V> | ITabSchema<V> | ITextSchema | IUnorderedListSchema<V> | IWrapperSchema<V>;
/**

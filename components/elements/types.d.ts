 ...
 */
export type TElementSchema<V = undefined, C = undefined> = IAccordionSchema<V, C> | IAlertSchema | IDividerSchema | IGridSchema<V, C> | IOrderedListSchema<V, C> | ITabItemSchema<V, C> | ITabSchema<V, C> | ITextSchema | IUnorderedListSchema<V, C> | IWrapperSchema<V, C>;
/**

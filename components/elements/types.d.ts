 ...
 */
export type TElementSchema<V = undefined, C = undefined> = TContainerElementSchema<V, C> | TBlockElementSchema<V, C> | TInlineElementSchema | TWrapperSchema<V, C>;
/** represent element schemas that render content containers */
export type TContainerElementSchema<V = undefined, C = undefined> = IAccordionSchema<V, C> | IGridSchema<V, C> | ITabItemSchema<V, C> | ITabSchema<V, C>;
/** represent element schemas that render block-level ui elements */
export type TBlockElementSchema<V = undefined, C = undefined> = IAlertSchema | IDividerSchema | IOrderedListSchema<V, C> | ITextSchema | ITypographySchema | IUnorderedListSchema<V, C>;

...
export type TTypographyType = "heading-xxl" | "heading-xl" | "heading-md" | "heading-sm" | "heading-lg" | "heading-xs" | "body-md" | "body-sm" | "body-bl" | "body-xs";
export interface ITypographySchema extends IBaseElementSchema<TTypographyType>, TComponentOmitProps<TypographyProps, "children"> {

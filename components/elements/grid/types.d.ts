...
export interface IGridSchema<V = undefined, C = undefined> extends Omit<IBaseElementSchema<"grid">, "label">, TComponentOmitProps<V2_ContainerProps, "children" | "stretch" | "type"> {

...
export interface IUnorderedListSchema<V = undefined, C = undefined> extends IBaseElementSchema<"unordered-list">, TComponentOmitProps<V2_UnorderedListProps, "children"> {
    children: (string | Record<string, IListItemSchema<V, C>>)[];
}
export interface IOrderedListSchema<V = undefined, C = undefined> extends IBaseElementSchema<"ordered-list">, TComponentOmitProps<V2_OrderedListProps, "children"> {
    children: (string | Record<string, IListItemSchema<V, C>>)[];
}

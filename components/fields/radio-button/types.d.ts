...
interface IRadioButtonToggleSchema<V = undefined, C = undefined> extends IBaseFieldSchema<"radio", V>, TComponentOmitProps<RadioButtonProps> {
...
export type IRadioButtonGroupSchema<V = undefined, C = undefined> = IRadioButtonDefaultSchema<V> | IRadioButtonToggleSchema<V, C> | IRadioButtonImageButtonSchema<V>;
export {};

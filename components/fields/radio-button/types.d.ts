...
interface IRadioButtonToggleSchema<V = undefined> extends IBaseFieldSchema<"radio", V>, TComponentOmitProps<RadioButtonProps> {
...
export type TRadioButtonGroupSchema<V = undefined> = IRadioButtonDefaultSchema<V> | IRadioButtonToggleSchema<V> | IRadioButtonImageButtonSchema<V>;
/** @deprecated will be removed in a future release. Use `TRadioButtonGroupSchema` instead */
export type IRadioButtonGroupSchema<V = undefined> = IRadioButtonDefaultSchema<V> | IRadioButtonToggleSchema<V> | IRadioButtonImageButtonSchema<V>;
export {};

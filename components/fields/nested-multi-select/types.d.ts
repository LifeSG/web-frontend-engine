...
export type TNestedMultiSelectProps = Pick<InputNestedMultiSelectProps<string, string, string>, "disabled" | "enableSearch" | "hideNoResultsDisplay" | "mode" | "optionTruncationType" | "placeholder" | "readOnly" | "searchPlaceholder" | "data-testid">;

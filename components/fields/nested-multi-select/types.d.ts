...
export type TNestedMultiSelectProps = Pick<InputNestedMultiSelectProps<string, string, string>, "disabled" | "enableSearch" | "hideNoResultsDisplay" | "listStyleWidth" | "mode" | "optionTruncationType" | "placeholder" | "readOnly" | "searchPlaceholder" | "data-testid">;
export interface INestedMultiSelectSchema<V = undefined> extends IBaseFieldSchema<"nested-multi-select", V>, React.HTMLAttributes<HTMLElement>, TComponentOmitProps<TNestedMultiSelectProps> {

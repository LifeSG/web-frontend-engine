...
export declare namespace LocationHelper {
     ...
     */
    const checkIsCoordinateOutsideSG: (coordinate: Partial<ILocationCoord>) => boolean;
    /**
     ...
     */
    const checkIsLocationOutsideSG: (location: ILocationFieldValues | undefined) => boolean;
    const hasGotAddressValue: (value?: string) => boolean;
    const hasNonSGBuildingValue: (building?: string) => boolean;

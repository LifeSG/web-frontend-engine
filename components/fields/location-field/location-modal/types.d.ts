...
export interface ILocationModalProps extends Pick<ILocationPickerProps, "mapPanZoom" | "interactiveMapPinIconUrl" | "legendItems">, Pick<ILocationSearchProps, "mapApi" | "mustHavePostalCode" | "gettingCurrentLocationFetchMessage" | "disableSearch" | "addressFieldPlaceholder" | "searchBarIcon" | "bufferRadius" | "restrictNonSGLocation"> {
    id: string;
    className: string;

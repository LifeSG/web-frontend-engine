...
export declare const ModalBox: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("styled-components").FastOmit<Omit<import("@lifesg/react-design-system/modal").ModalBoxProps & import("react").RefAttributes<HTMLDivElement>, "ref"> & {
    ref?: import("react").Ref<HTMLDivElement>;
}, "locationModalStyles"> & IModalBoxStyle, never> & Partial<Pick<import("styled-components").FastOmit<Omit<import("@lifesg/react-design-system/modal").ModalBoxProps & import("react").RefAttributes<HTMLDivElement>, "ref"> & {
    ref?: import("react").Ref<HTMLDivElement>;
}, "locationModalStyles"> & IModalBoxStyle, never>>> & string & Omit<(props: import("@lifesg/react-design-system/modal").ModalBoxProps & import("react").RefAttributes<HTMLDivElement>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>, keyof import("react").Component<any, {}, any>>;

...
export declare const ResultTitle: import("styled-components").StyledComponent<"h5", any, import("@lifesg/react-design-system").V2_TextProps, never>;
export declare const NoResultTitle: import("styled-components").StyledComponent<"p", any, import("@lifesg/react-design-system").V2_TextProps, never>;

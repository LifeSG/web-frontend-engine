...
export declare const Banner: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("@lifesg/react-design-system/card/types").CardProps, never> & Partial<Pick<import("@lifesg/react-design-system/card/types").CardProps, never>>> & string & Omit<({ children, ...otherProps }: import("@lifesg/react-design-system/card/types").CardProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;

...
interface WeekSchema<V = undefined> extends IFrontendEngineBaseFieldJsonSchema<"date-range-field", V, undefined>, TComponentOmitProps<DateRangeInputProps, "valueEnd"> {
    variant: "week";
    dateFormat?: string | undefined;
}
interface RangeSchema<V = undefined> extends IFrontendEngineBaseFieldJsonSchema<"date-range-field", V, IDateRangeFieldValidationRule>, TComponentOmitProps<DateRangeInputProps, "valueEnd"> {
    variant: "range";
    dateFormat?: string | undefined;
}

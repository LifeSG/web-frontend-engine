...
export declare const StyledCheckbox: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("@lifesg/react-design-system/checkbox").CheckboxProps, never> & Partial<Pick<import("@lifesg/react-design-system/checkbox").CheckboxProps, never>>> & string & Omit<({ className, checked, disabled, focusableWhenDisabled, indeterminate, displaySize, id, tabIndex, onChange, ...otherProps }: import("@lifesg/react-design-system/checkbox").CheckboxProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;

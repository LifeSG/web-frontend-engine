...
export declare const Subtitle: import("styled-components").StyledComponent<"p", any, import("@lifesg/react-design-system/v2_text").V2_TextProps & SubtitleProps, never>;

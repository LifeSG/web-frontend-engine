...
export interface IESignatureFieldSchema<V = undefined> extends IBaseFieldSchema<"e-signature-field", V>, Pick<EsignatureProps, "className" | "data-testid" | "description"> {
    upload?: {
        url: string;

...
export interface IFileUploadSchema<V = undefined> extends IBaseFieldSchema<"file-upload", V, IFileUploadValidationRule>, Pick<FileUploadProps, "capture" | "data-testid" | "disabled" | "readOnly" | "styleType"> {
...
export declare enum EFileStatus {
    INJECTED = -99,
    INJECTING = -98,
    TO_DELETE = -4,
    ERROR_FORMAT = -3,
...
declare function fileUploadEvent(uiType: "file-upload", type: "mount", id: string, listener: TFieldEventListener, options?: boolean | AddEventListenerOptions | undefined): void;
/** fired when file upload throws error */
declare function fileUploadEvent(uiType: "file-upload", type: "upload-error", id: string, listener: TFieldEventListener<TUploadErrorDetail>, options?: boolean | AddEventListenerOptions | undefined): void;

 ...
 */
export type TFieldSchema<V = undefined> = IButtonSchema | IChipsSchema<V> | IContactFieldSchema<V> | IDateFieldSchema<V> | IEmailFieldSchema<V> | IFileUploadSchema<V> | IHiddenFieldSchema<V> | IHistogramSliderSchema<V> | IImageUploadSchema<V> | ILocationFieldSchema<V> | IMaskedFieldSchema<V> | IMultiSelectSchema<V> | IRangeSelectSchema | INestedMultiSelectSchema<V> | INumericFieldSchema<V> | IResetButtonSchema | ISelectSchema<V> | ISliderSchema<V> | ISubmitButtonSchema | ISwitchSchema<V> | ITextareaSchema<V> | ITextFieldSchema<V> | ITimeFieldSchema<V> | IUnitNumberFieldSchema<V> | TCheckboxGroupSchema<V> | TDateRangeFieldSchema<V> | TRadioButtonGroupSchema<V>;
